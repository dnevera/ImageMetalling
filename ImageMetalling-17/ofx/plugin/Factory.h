...
namespace imetalling::falsecolor {
    ...
    public:
        ...
        /***
         * Заполнение контекста конкретного плашина. Создания настроичных параметров, которые затем
         * отображаются в виде полей ввода, кнопок, слейдеров и прочих контролв в панеле плагина в хостовой программе.
         * @param desc
         * @param p_Context
         */
